...
<body>
    ...
    <div class="col-auto sidebar">
        <ul class="sidebar-menu">
            <li>
                <a href="../../3hte/htedashboard.php" tooltip-side="Dashboard">
            ...
            <li>
                <a href="../../3hte/document/document.php" tooltip-side="Document Requirements">
            ...
            <li>
                <a href="../../3hte/intern_list/intern_list.php" tooltip-side="List of Assign Interns">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="34" height="34" stroke-width="2">
            ...
            <li>
                <a href="../../3hte/chat/chat.php" tooltip-side="Chat Room">
