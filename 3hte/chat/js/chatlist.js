...
function loadChatList() {
  fetch("../../3hte/chat/fetch_chatlist.php")
      ...
      data.forEach((user) => {
        ...
        if (!chatCard) {
          ...
          chatCard.addEventListener("click", function () {
            ...
            fetch("../../3hte/chat/mark_as_read.php", {
              method: "POST",
...
function fetchMessages(userId) {
  ...
  fetch(
    `../../3hte/chat/fetch_messages.php?with_user_id=${userId}&last_id=${lastMessageId}`
  )
    .then((response) => response.json())
    .then((data) => {
        ...
        if (data.messages.length > 0) {
          data.messages.forEach((msg) => {
            ...
            if (msg.attachment) {
              ...
              const fileUrl = `../../3hte/chat/serve_file.php?path=${encodeURIComponent(
...
function deleteMessage(messageId, iconElement) {
  ...
  fetch("../../3hte/chat/delete_message.php", {
    method: "POST",
    headers: { "Content-Type": "application/x-www-form-urlencoded" },
...
function handleSendMessage(e) {
  ...
  fetch("../../3hte/chat/send_message.php", {
    method: "POST",
...
function handleFileUpload() {
  ...
  fetch("../../3hte/chat/upload_attachment.php", {
    method: "POST",
    body: formData,
  })
    .then((res) => res.json())
