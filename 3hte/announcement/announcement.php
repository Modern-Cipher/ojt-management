        ...
        <div class="row">
            ...
            <div class="col-auto sidebar">
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="../../3hte/predeploy/predeploy.php" data-bs-toggle="tooltip" title="Document Requirements">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li data-bs-toggle="tooltip" title="Internship Management">
                        ...
                        <ul id="submenu2" class="collapse sub-menu">
                            <li>
                                <a href="../../3hte/intern_deploy/intern_deploy.php" data-bs-toggle="tooltip" title="List of Assign Interns">
                            ...
                            <li>
                                <a href="../../3hte/list_request/list_request.php" data-bs-toggle="tooltip" title="List of Intern Documents">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="26" height="26" stroke-width="2">
                    ...
                    <div class="dashboard-main">
                        ...
                        <div id="announcementContainer" class="announcements">
                            ...
                            <div id="latestAnnouncement">
                                <?php include("../../3hte/announcement/fetch_latest_announcement_trainer.php"); ?>
                            </div>
                            ...
                            <div id="extra-announcements" class="extra-announcements" style="display: none;">
                                ...
                                <div id="recentAnnouncements">
                                    <?php include("../../3hte/announcement/fetch_recent_announcement_trainer.php"); ?>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            document.querySelectorAll(".status-toggle").forEach(toggle => {
                toggle.addEventListener("change", function() {
                    ...
                    fetch("../../3hte/announcement/toggle_status_trainer.php", {
                            method: "POST",
                            headers: {
...
<!-- not used fetch comments -->
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (commentForm && commentInput && commentSection) {
                commentForm.addEventListener("submit", function(e) {
                    ...
                    fetch("../../3hte/announcement/save_comment_trainer.php", {
                            method: "POST",
                            body: formData
                        })
                ...
                function loadComments(announcementId) {
                    fetch("../../3hte/announcement/fetch_comments.php?announcement_id=" + announcementId)
                        .then(response => response.text())
                        .then(data => {
    ...
    <script>
        ...
        function reloadAnnouncementSection() {
            // Reload latest
            fetch("../../3hte/announcement/fetch_latest_announcement_trainer.php")
                .then(res => res.text())
                .then(data => {
            ...
            // Reload recent
            fetch("../../3hte/announcement/fetch_recent_announcement_trainer.php")
                .then(res => res.text())
                .then(data => {
