...
<head>
    ...
    <link rel="stylesheet" href="../../3hte/intern_list/css/topbar.css">
    <link rel="stylesheet" href="../../3hte/intern_list/css/leftsidebar.css">
    <link rel="stylesheet" href="../../3hte/intern_list/css/dashboard.css">
...
<body>
    ...
    <div class="parent">
        <!-- LEFT COLUMN -->
        <div class="div1">
            <h5 class="mb-3 fw-semibold">Internship List</h5>
            ...
            <!-- Scrollable student list (dynamic) -->
            <div class="student-list-scroll">
                <!-- ✅ Cards will be populated here dynamically via fetch_students.js -->
                <p class="text-muted small">Loading student data...</p>
            </div>
        </div>
        ...
        <!-- RIGHT COLUMN -->
        <div class="div2">
            <h5 class="mb-3 fw-semibold">Details</h5>

            <div class="card shadow-sm mb-3 p-3">
                <div class="card-body text-center" id="student-details">

                    <!-- Placeholder message -->
                    <p class="text-muted">Click a student on the left to view their details.</p>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0">
                    <div class="modal-body p-0">
                        <img src="../../upload_profile/siplogo.png"
                            onerror="this.onerror=null;this.src='../../upload_profile/siplogo.png';"
                            alt="Full Profile"
                            class="img-fluid w-100 student-profile-img rounded-top" id="modal-profile-img">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="../../3hte/intern_list/js/tooltip.js"></script>
    <script src="../../3hte/intern_list/js/fetch_students.js"></script>
