...
<head>
    ...
    <link rel="stylesheet" href="../../3hte/document/css/topbar.css">
    <link rel="stylesheet" href="../../3hte/document/css/leftsidebar.css">
    <link rel="stylesheet" href="../../3hte/document/css/dashboard_body.css">
    <link rel="stylesheet" href="../../3hte/document/css/card_design.css">
...
<body>
                    ...
                    <div class="dashboard-main">
                        <div class="dashboard-content">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="m-0">Higher Education Institute Requirements</h5>
    ...
    <script src="../../3hte/document/js/tooltip.js"></script>
    <script src="../../3hte/document/js/search.js"></script>
    <script src="../../3hte/document/js/upload.js"></script>
    <script src="../../3hte/document/js/load_files.js"></script>
    <script>
