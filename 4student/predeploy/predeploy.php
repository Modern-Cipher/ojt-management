...
<head>
    ...
    <link rel="stylesheet" href="../../4student/predeploy/css/topbar.css">
    <link rel="stylesheet" href="../../4student/predeploy/css/leftsidebar.css">
    <link rel="stylesheet" href="../../4student/predeploy/css/dashboard_body.css">
    <link rel="stylesheet" href="../../4student/predeploy/css/card_design.css">
...
<body>
                ...
                <div class="dashboard-main">
                    <div class="dashboard-content">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="m-0">Pre Deployment Requirements</h5>
    ...
    <script src="../../4student/predeploy/js/tooltip.js"></script>
    <script src="../../4student/predeploy/js/search.js"></script>
    <script src="../../4student/predeploy/js/upload.js"></script>
    <script src="../../4student/predeploy/js/load_files.js"></script>
    <script>
