...
<head>
    ...
    <link rel="stylesheet" href="../../4student/chat/css/topbar.css">
    <link rel="stylesheet" href="../../4student/chat/css/leftsidebar.css">
    <link rel="stylesheet" href="../../4student/chat/css/dashboard.css">
    <link rel="stylesheet" href="../../4student/chat/css/tooltip.css">
    <link rel="stylesheet" href="../../4student/chat/css/chatlist.css">
    <link rel="stylesheet" href="../../4student/chat/css/chatmessages.css">
</head>
...
<body>
    ...
    <div class="col-auto sidebar">
        <ul class="sidebar-menu">
            <li>
                <a href="../../4student/studentdashboard.php" tooltip-side="Dashboard">
            ...
            <li>
                <a href="../../4student/predeploy/predeploy.php" tooltip-side="Pre Deployment">
            ...
            <li>
                <a href="../../4student/postdeploy/postdeploy.php" tooltip-side="Post Deployment">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="34" height="34" stroke-width="2">
                        <path d="M14 3v4a1 1 0 0 0 1 1h4"></path>
            ...
            <li>
                <a href="../../4student/journal/journal.php" tooltip-side="My Journal">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="34" height="34" stroke-width="2">
            ...
            <li>
                <a href="../../4student/chat/chat.php" tooltip-side="Chat Room">
    ...
    <script src="../../4student/chat/js/tooltip.js"></script>
    <script src="../../4student/chat/js/toast.js"></script>
    <script src="../../4student/chat/js/chatlist.js"></script>
</body>
