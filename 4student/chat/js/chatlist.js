...
function loadChatList() {
  fetch("../../4student/chat/fetch_chatlist.php")
      ...
      data.forEach((user) => {
        ...
        if (!chatCard) {
          ...
          chatCard.addEventListener("click", function () {
            ...
            fetch("../../4student/chat/mark_as_read.php", {
              method: "POST",
...
function fetchMessages(userId) {
  ...
  fetch(
    `../../4student/chat/fetch_messages.php?with_user_id=${userId}&last_id=${lastMessageId}`
  )
    .then((response) => response.json())
    .then((data) => {
        ...
        if (data.messages.length > 0) {
          data.messages.forEach((msg) => {
            ...
            if (msg.attachment) {
              ...
              const fileUrl = `../../4student/chat/serve_file.php?path=${encodeURIComponent(
...
function deleteMessage(messageId, iconElement) {
  ...
  fetch("../../4student/chat/delete_message.php", {
    method: "POST",
    headers: { "Content-Type": "application/x-www-form-urlencoded" },
...
function handleSendMessage(e) {
  ...
  fetch("../../4student/chat/send_message.php", {
    method: "POST",
...
function handleFileUpload() {
  ...
  fetch("../../4student/chat/upload_attachment.php", {
    method: "POST",
    body: formData,
  })
    .then((res) => res.json())
