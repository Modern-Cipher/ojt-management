...
// ✅ Fetch latest relevant announcement for student
...
if ($announcement = $result->fetch_assoc()) {
    ...
    while ($comment = $commentResult->fetch_assoc()) {
        ...
        <div class='comment-item'>
            ...
            <a href='announcement/delete_comment_student.php?comment_id=$commentId' onclick=\"return confirm('Are you sure you want to delete this comment?')\" data-bs-toggle='tooltip' title='Remove' style='margin-left:10px; color:red;'>
