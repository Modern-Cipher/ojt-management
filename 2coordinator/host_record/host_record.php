...
<head>
    ...
    <title>Host Training Documents</title>
    ...
    <link rel="stylesheet" href="../../2coordinator/host_record/css/topbar.css">
    <link rel="stylesheet" href="../../2coordinator/host_record/css/leftsidebar.css">
    <link rel="stylesheet" href="../../2coordinator/host_record/css/dashboard.css">
    <link rel="stylesheet" href="../../2coordinator/host_record/css/card_details.css">
    <link rel="stylesheet" href="../../2coordinator/host_record/css/dashboard_card.css">
    <link rel="stylesheet" href="../../2coordinator/host_record/css/timeline.css">
    <link rel="stylesheet" href="../../2coordinator/host_record/css/comment.css">
    <link rel="stylesheet" href="../../2coordinator/host_record/css/tooltip.css">
...
<body>
    ...
    <div class="parent">
        <div class="div3">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="m-0">Host Trainer List</h5>
                <input type="text" id="searchInput" class="form-control w-50" placeholder="Search Trainer...">
            </div>
        </div>

        <div class="div4 scrollable-cards" id="cardContainer">
            <!-- fetching trainer list -->
        </div>


        <div class="div6 text-end fw-semibold fs-6">
            Host Training Establishment Documents
        </div>


        <div class="div7 scrollable-cards">
            <div class="timeline"></div>
            <div id="coordinatorInfo" data-id="<?php echo $user_id; ?>" hidden></div>
        </div>
    ...
    <script src="../../2coordinator/host_record/js/search_trainer.js"></script>
    <script src="../../2coordinator/host_record/js/tooltip.js"></script>
    <script src="../../2coordinator/host_record/js/toast.js"></script>
    <!-- <script src="../../2coordinator/host_record/js/status.js"></script> -->
    <!-- <script src="../../2coordinator/host_record/js/comment.js"></script> -->
    <script src="../../2coordinator/host_record/js/dashboard_filename.js"></script> <!-- HULI palagi ito -->
