...
<head>
    ...
    <link rel="stylesheet" href="../2coordinator/css/dashboard_body.css">
    <link rel="stylesheet" href="../2coordinator/css/announcement.css">
    <link rel="stylesheet" href="../2coordinator/css/dashboard_graphs.css">
...
<body>
                    ...
                    <div class="dashboard-main">
                        ...
                        <div id="announcementContainer" class="announcements">
                            <div class="announcement-header" style=" margin-top:30px;">
                                <h5>Announcement</h5>
                                <a href="../2coordinator/announcement/announcement.php" data-bs-toggle="tooltip" title="Create New Announcement">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" width="34" height="34" stroke-width="2">
                            ...
                            <div id="latestAnnouncement">
                                <?php include("../2coordinator/announcement/fetch_latest_announcement_coordinator1.php"); ?>
                            </div>

                            <a href="#" class="view-history" id="toggle-announcement-btn">
                            ...
                            <div id="extra-announcements" class="extra-announcements" style="display: none;">
                                ...
                                <div id="recentAnnouncements">
                                    <?php include("../2coordinator/announcement/fetch_recent_announcement_coordinator1.php"); ?>
                                </div>
                            </div>
                        </div>
    ...
    <script src="../2coordinator/js/toggle.js"></script>
    <script src="../2coordinator/js/announce.js"></script>
    <script src="../2coordinator/js/dashboard_counts_coordinator.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <script src="../2coordinator/js/chart1.js"></script>
    <script src="../2coordinator/js/chart2_documents.js"></script>
