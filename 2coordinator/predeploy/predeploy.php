...
<head>
    ...
    <link rel="stylesheet" href="../../2coordinator/predeploy/css/topbar.css">
    <link rel="stylesheet" href="../../2coordinator/predeploy/css/leftsidebar.css">
    <link rel="stylesheet" href="../../2coordinator/predeploy/css/dashboard.css">
    <link rel="stylesheet" href="../../2coordinator/predeploy/css/card_details.css">
    <link rel="stylesheet" href="../../2coordinator/predeploy/css/dashboard_card.css">
    <link rel="stylesheet" href="../../2coordinator/predeploy/css/timeline.css">
    <link rel="stylesheet" href="../../2coordinator/predeploy/css/comment.css">
    <link rel="stylesheet" href="../../2coordinator/predeploy/css/tooltip.css">
...
<body>
    ...
    <div class="parent">
        <div class="div3">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="m-0">Pre Deployment Student List</h5>
    ...
    <script src="../../2coordinator/predeploy/js/search_students.js"></script>
    <script src="../../2coordinator/predeploy/js/tooltip.js"></script>
    <script src="../../2coordinator/predeploy/js/toast.js"></script>
    <script src="../../2coordinator/predeploy/js/dashboard_filename.js"></script> <!-- HULI palagi ito -->
