...
$uploadedbyId = $_GET['uploadedby_id'] ?? null; // student_id
...
AND (
    (fc.commenter_id = ? AND fc.uploadedby_id = ?) -- coordinator reply to student
    OR
    (fc.commenter_id = ? AND (fc.uploadedby_id IS NULL OR fc.uploadedby_id = 0)) -- student's own comment
)
