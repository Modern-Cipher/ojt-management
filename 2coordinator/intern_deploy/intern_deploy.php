...
<head>
    ...
    <title>Internship List and Request</title>
    ...
    <link rel="stylesheet" href="../../2coordinator/intern_deploy/css/intern_deploy_body.css">
    <link rel="stylesheet" href="../../2coordinator/intern_deploy/css/intern_deploy.css">
    <link rel="stylesheet" href="../../2coordinator/intern_deploy/css/intern_deploy_table.css">
    <link rel="stylesheet" href="../../2coordinator/intern_deploy/css/details.css">
...
<body>
    ...
    <div class="container-fluid main-container">
                ...
                <div class="dashboard-main">
                    ...
                    <div class="dashboard-content">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3 announcement-header">
                            <h5 class="announcement-title">Internship Deployment</h5>
                            <div class="d-flex align-items-center">
                            ...
                            <div class="modal-dialog">
                                <form id="assignForm">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Assign Host Training Establishment</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <input type="hidden" name="user_id" id="assignUserId">
                                            <div class="mb-3">
                                                <label class="form-label">Host Training Establishment</label>
                                                <select class="form-select" name="hte_id" id="hteSelect"></select>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">OJT Status</label>
                                                <select class="form-select" name="ojt_status" id="ojtStatusSelect"></select>
                                            </div>
                                        </div>
                            ...
                            <table class="table table-bordered table-hover" id="intern_deploy_Table">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th onclick="sortTable(3)">Assigned</th>
                                        <th onclick="sortTable(4)">Host Trainer</th>
                        ...
                        <div class="container mt-3">
                            <div class="card student-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Student Name -->
                                    <p class="student-name">No student selected</p>
                                    ...
                                    <div class="info-section">
                                        <strong>Host Training Establishment</strong><br><br>
                                    ...
                                    <div class="info-section">
                                        <strong>Host Trainer</strong><br><br>
        ...
        <script src="../../2coordinator/intern_deploy/js/search_sorting.js"></script>
        <script src="../../2coordinator/intern_deploy/js/tooltip.js"></script>
        <script src="../../2coordinator/intern_deploy/js/history.js"></script>
        <script src="../../2coordinator/intern_deploy/js/fetch_student_list.js"></script>
        <script src="../../2coordinator/intern_deploy/js/edit_modal.js"></script>
        <script src="../../2coordinator/intern_deploy/js/student_card.js"></script>
        <!-- <script src="../../2coordinator/intern_deploy/js/loadcard.js"></script> -->
