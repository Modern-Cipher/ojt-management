...
<head>
    ...
    <link rel="stylesheet" href="../../2coordinator/postdeploy/css/topbar.css">
    <link rel="stylesheet" href="../../2coordinator/postdeploy/css/leftsidebar.css">
    <link rel="stylesheet" href="../../2coordinator/postdeploy/css/dashboard.css">
    <link rel="stylesheet" href="../../2coordinator/postdeploy/css/card_details.css">
    <link rel="stylesheet" href="../../2coordinator/postdeploy/css/dashboard_card.css">
    <link rel="stylesheet" href="../../2coordinator/postdeploy/css/timeline.css">
    <link rel="stylesheet" href="../../2coordinator/postdeploy/css/comment.css">
    <link rel="stylesheet" href="../../2coordinator/postdeploy/css/tooltip.css">
...
<body>
    ...
    <div class="parent">
        <div class="div3">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="m-0">Post Deployment Student List</h5>
                <input type="text" id="searchInput" class="form-control w-50" placeholder="Search Student...">
            </div>
        </div>
    ...
    <script src="../../2coordinator/postdeploy/js/search_students.js"></script>
    <script src="../../2coordinator/postdeploy/js/tooltip.js"></script>
    <script src="../../2coordinator/postdeploy/js/toast.js"></script>
    <script src="../../2coordinator/postdeploy/js/dashboard_filename.js"></script> <!-- HULI palagi ito -->
