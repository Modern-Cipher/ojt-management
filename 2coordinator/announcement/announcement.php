...
<body>
                ...
                <h5 class="dashboard-header">
                    <div class="dashboard-main">
                        ...
                        <div class="dashboard-content">
                            ...
                            <!-- ✅ Add Announcement Modal (Coordinator Version) -->
                            <div class="modal fade" id="addAnnouncementModal" tabindex="-1" aria-labelledby="addAnnouncementLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="../../2coordinator/announcement/add_announcement_coordinator.php" method="POST">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-footer">
                                                <!-- ✅ Submit Button Only (No Cancel, since may "X" sa header) -->
                        ...
                        <div id="announcementContainer" class="announcements">
                            ...
                            <div id="latestAnnouncement">
                                <?php include("../../2coordinator/announcement/fetch_latest_announcement_coordinator.php"); ?>
                            </div>
                            ...
                            <div id="extra-announcements" class="extra-announcements" style="display: none;">
                                ...
                                <div id="recentAnnouncements">
                                    <?php include("../../2coordinator/announcement/fetch_recent_announcement_coordinator.php"); ?>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- ✅ Edit Announcement Modal for Coordinator -->
    <div class="modal fade" id="editAnnouncementModal" tabindex="-1" aria-labelledby="editAnnouncementLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="../../2coordinator/announcement/update_announcement_coordinator.php" method="POST">
                    <div class="modal-header">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            document.querySelectorAll(".status-toggle").forEach(toggle => {
                toggle.addEventListener("change", function() {
                    ...
                    fetch("../../2coordinator/announcement/toggle_status_coordinator.php", {
                            method: "POST",
                            headers: {
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (commentForm && commentInput && commentSection) {
                commentForm.addEventListener("submit", function(e) {
                    ...
                    fetch("../../2coordinator/announcement/save_comment_coordinator.php", {
                            method: "POST",
                            body: formData
                        })
                ...
                function loadComments(announcementId) {
                    fetch("../../2coordinator/announcement/fetch_comments.php?announcement_id=" + announcementId)
                        .then(response => response.text())
                        .then(data => {
    ...
    <script>
        ...
        function reloadAnnouncementSection() {
            // Reload latest
            fetch("../../2coordinator/announcement/fetch_latest_announcement_coordinator.php")
                .then(res => res.text())
                .then(data => {
            ...
            // Reload recent
            fetch("../../2coordinator/announcement/fetch_recent_announcement_coordinator.php")
                .then(res => res.text())
                .then(data => {
