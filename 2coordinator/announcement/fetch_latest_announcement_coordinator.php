...
if ($announcement = $result->fetch_assoc()) {
    ...
    while ($comment = $commentResult->fetch_assoc()) {
        ...
        <div class='comment-item'>
            ...
            <a href='delete_comment_coordinator.php?comment_id=$commentId' onclick=\"return confirm('Are you sure you want to delete this comment?')\" data-bs-toggle='tooltip' title='Remove' style='margin-left:10px; color:red;'>
    ...
    echo "</div>
    <form class='comment-input mt-2' method='POST' action='../../2coordinator/announcement/save_comment_coordinator.php'>
