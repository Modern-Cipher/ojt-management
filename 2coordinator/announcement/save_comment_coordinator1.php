...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['announcement_id'], $_POST['comments'])) {
    ...
    if (!empty($comment)) {
        ...
        // ✅ Redirect back
        echo "<script>window.location.href = '../../2coordinator/coordinatordashboard.php';</script>";
    } else {
        echo "<script>alert('Comment is required.'); window.location.href = '../../2coordinator/coordinatordashboard.php';</script>";
    }
} else {
