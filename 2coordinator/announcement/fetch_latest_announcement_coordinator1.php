...
$sql = "SELECT a.announcements_id, a.title, a.content, a.created_at, u.username, u.fname, u.role, u.image_profile
        ...
        WHERE a.announce_status = 'posted'
          AND u.institute = ?
          AND (
              (u.role = 'admin' AND a.role IN ('all', 'coordinator'))
              OR a.users_id = ?
          )
...
if ($announcement = $result->fetch_assoc()) {
    ...
    while ($comment = $commentResult->fetch_assoc()) {
        ...
        <div class='comment-item'>
            ...
            <a href='announcement/delete_comment_coordinator1.php?comment_id=$commentId' onclick=\"return confirm('Are you sure you want to delete this comment?')\" data-bs-toggle='tooltip' title='Remove' style='margin-left:10px; color:red;'>
    ...
    echo "</div>
    <form class='comment-input mt-2' method='POST' action='announcement/save_comment_coordinator1.php'>
