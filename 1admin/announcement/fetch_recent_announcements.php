...
// ✅ Get the latest announcement ID (not just timestamp)
// ✅ Get the latest announcement ID (most recent posted regardless of role)
...
if ($result->num_rows > 0) {
    while ($announcement = $result->fetch_assoc()) {
        ...
        $creatorName = !empty($announcement['fname']) ? $announcement['fname'] : $announcement['username'];
        ...
        while ($comment = $commentResult->fetch_assoc()) {
            ...
            <div class='comment-item'>
                ...
                <p class='comment-text'>
                    " . nl2br(htmlspecialchars($comment['comments'])) .
                ($comment['users_id'] == $user_id ? "
                    <a href='delete_comment.php?comment_id=$commentId' onclick=\"return confirm('Are you sure you want to delete this comment?')\" data-bs-toggle='tooltip' title='Remove' style='margin-left:10px; color:red;'>
        ...
        echo "</div>
        <form class='comment-input mt-2' method='POST' action='../../1admin/announcement/save_comment.php'>
