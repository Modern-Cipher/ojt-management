...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['announcement_id'], $_POST['comments'])) {
    ...
    if (!empty($comment)) {
        ...
        // ✅ Redirect back
        echo "<script>window.location.href = '../../1admin/admindashboard.php';</script>";

    } else {
        echo "<script>alert('Comment is required.'); window.location.href = '../../1admin/admindashboard.php';</script>";
    }
} else {
