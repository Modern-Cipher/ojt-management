...
if ($announcement = $result->fetch_assoc()) {
    ...
    while ($comment = $commentResult->fetch_assoc()) {
        ...
        if ($comment['users_id'] == $user_id) {
            echo "<a href='announcement/delete_comment1.php?comment_id=$commentId' onclick=\"return confirm('Are you sure you want to delete this comment?')\" data-bs-toggle='tooltip' title='Remove' style='margin-left:10px; color:red;'>
