...
while ($announcement = $result->fetch_assoc()) {
    ...
    while ($comment = $commentResult->fetch_assoc()) {
        ...
        <div class='comment-item'>
            ...
            <a href='announcement/delete_comment1.php?comment_id=$commentId' onclick=\"return confirm('Are you sure you want to delete this comment?')\" style='margin-left:10px; color:red;' data-bs-toggle='tooltip' title='Remove'>
    ...
    echo "</div>
    <form class='comment-input mt-2' method='POST' action='announcement/save_comment1.php'>
