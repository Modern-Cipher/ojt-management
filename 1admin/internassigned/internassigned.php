...
<head>
    ...
    <link rel="stylesheet" href="../../1admin/internassigned/css/topbar.css">
    <link rel="stylesheet" href="../../1admin/internassigned/css/leftsidebar.css">
    <link rel="stylesheet" href="../../1admin/internassigned/css/dashboard.css">
</head>
    ...
    <div class="parent">
        ...
        <div class="div1">
            ...
            <div class="search-container mb-3">
                <input type="text" class="form-control form-control-sm" id="coordinatorSearch" placeholder="Search coordinator...">
            </div>
            <div class="coordinator-list-scroll">
                <!-- Coordinators will be dynamically inserted here by coordinator_list.js -->
            </div>
        </div>

        <!-- MIDDLE COLUMN (Scrollable) -->
        <div class="div2">
            <h5 class="mb-3 fw-semibold">Student Intern List</h5>
        ...
        <div class="div3">
            ...
            <div class="info-scroll">
                <!-- Student info will be dynamically inserted here by JS -->
            </div>
        </div>
