...
function loadChatList() {
  fetch("../../1admin/chat/fetch_chatlist.php")
      ...
      data.forEach((user) => {
        ...
        if (!chatCard) {
          ...
          chatCard.addEventListener("click", function () {
            ...
            fetch("../../1admin/chat/mark_as_read.php", {
              method: "POST",
...
function fetchMessages(userId) {
  ...
  fetch(
    `../../1admin/chat/fetch_messages.php?with_user_id=${userId}&last_id=${lastMessageId}`
  )
    .then((response) => response.json())
    .then((data) => {
        ...
        if (data.messages.length > 0) {
          data.messages.forEach((msg) => {
            ...
            if (msg.attachment) {
              ...
              const fileUrl = `../../1admin/chat/serve_file.php?path=${encodeURIComponent(
...
function deleteMessage(messageId, iconElement) {
  ...
  fetch("../../1admin/chat/delete_message.php", {
    method: "POST",
    headers: { "Content-Type": "application/x-www-form-urlencoded" },
...
function handleSendMessage(e) {
  ...
  fetch("../../1admin/chat/send_message.php", {
    method: "POST",
...
function handleFileUpload() {
  ...
  fetch("../../1admin/chat/upload_attachment.php", {
    method: "POST",
    body: formData,
  })
    .then((res) => res.json())
