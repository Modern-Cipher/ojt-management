...
<head>
    ...
    <link rel="stylesheet" href="../../1admin/establishment/css/topbar.css">
    <link rel="stylesheet" href="../../1admin/establishment/css/leftsidebar.css">
    <link rel="stylesheet" href="../../1admin/establishment/css/dashboard.css">
</head>
...
<body>
    ...
    <div class="parent">
        ...
        <div class="div1">
            <h5 class="mb-3 fw-semibold">Assigned Coordinator</h5>
            <div class="search-container mb-3">
                <input type="text" class="form-control form-control-sm" placeholder="Search coordinator...">
            </div>
            <div class="coordinator-list-scroll"></div> <!-- ✅ Dynamically loaded -->
        </div>

        <!-- MIDDLE COLUMN (Scrollable) -->
        <div class="div2">
            <h5 class="mb-3 fw-semibold">Host Trainer</h5>
            <div class="search-container mb-3">
                <input type="text" class="form-control form-control-sm" placeholder="Search trainer...">
            </div>
            <div class="student-list-scroll"></div> <!-- ✅ Dynamically loaded -->
        </div>

        <!-- RIGHT COLUMN (Now Scrollable) -->
        <div class="div3">
            <h5 class="mb-3 fw-semibold">Information</h5>
            <div class="info-scroll"></div> <!-- ✅ Dynamically loaded -->
        </div>
    </div>
    ...
    <script src="../../1admin/establishment/js/tooltip.js"></script>
    <script src="../../1admin/establishment/js/coordinator_list.js"></script>
    <script src="../../1admin/establishment/js/load_trainers.js"></script>
    <script src="../../1admin/establishment/js/load_trainer_info.js"></script>
